...
export const confirmationEmail = async (lang: SubscriptionCollectionLanguageType, data: { link: string; }, siteConfig: SiteConfigurationType) => sprightly(`dist/templates/${  siteConfig.mail.templatePath  }/confirmation_${  lang  }.html`, {
  lang,
  link: data.link,
});
...
export const expiryEmail = async (lang: SubscriptionCollectionLanguageType, data: { 
  ...
  removal_date: string,
  remove_link: string }, siteConfig: SiteConfigurationType) => sprightly(`dist/templates/${  siteConfig.mail.templatePath  }/expiry_notification_${  lang  }.html`, {
  lang,
  link: data.link,
